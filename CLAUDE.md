...
**YOU ARE IN: `toktrace/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/toktrace/` (rig root) or other directories
...
**Your mail address:** `toktrace/polecats/chrome`
**Your rig:** toktrace
**Your Witness:** `toktrace/witness`
...
| Ask Witness for help | `gt mail send toktrace/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`toktrace/witness`) when:
...
```bash
gt mail send toktrace/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
